...
st.set_page_config(page_title="Chad IA", page_icon="🗿")
st.title("prueba de chatboti")

nombre = st.text_input("¿Como te llama pibe?")
if st.button("enviar"):
    st.write(f"Hola {nombre}! Bienvenido a mi chat gipiti👽")
    
MODELOS = ['llama-3.1-8b-instant', 'llama-3.3-70b-versatile', 'deepseek-r1-distill-llama-70b']

def configurar_pagina():
    st.title("IA - Frakillo")
...
# python -m streamlit run chadAI.py                      